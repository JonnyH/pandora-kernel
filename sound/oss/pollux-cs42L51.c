...
pollux_audio_open(struct inode *inode, struct file *file)
{
	...
	printk("HYUN_DEBUG: pollux_audio_open() \n");
...
pollux_audio_release(struct inode *inode, struct file *file)
{
    ...
    if (file->f_mode & FMODE_READ)
    {
        ...
        //cs42L51_write_byte(CS42L51_PWR_CTRL, STEREO_DAC_ON_MIC_PGA_OFF);
		//cs42L51_write_byte(CS42L51_SPDPWR_CTRL, MIC_MICBIAS_OFF);
    	//cs42L51_write_byte(CS42L51_IF_CTRL, 0x0E);  //04	
