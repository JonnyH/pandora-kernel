...
#define POLLUX_UART_NR_PORTS	(4) // 4개의 포트를 사용한다.
#if 1
	#define UART_BASE_DIV           (26) // from wince bsp, 147Mhz
#else
	#define UART_BASE_DIV           (24) // from wince bsp, 132.75Mhz, (132750000(PLL1) / 24 ) / 1843200(16x115200) = 3.00 -1 
#endif
