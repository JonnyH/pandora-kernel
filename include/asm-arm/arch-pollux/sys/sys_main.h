...
//// PRIMARY/SECONDARY MLC ////
#if defined (CONFIG_FB_POLLUX_LCD43) && defined(CONFIG_FB_POLLUX_LCD43_24BIT)
	#define DISPLAY_MLC_RGB_FORMAT                            					MLC_RGBFMT_R8G8B8
	#define DISPLAY_MLC_BYTE_PER_PIXEL                        					3
#else
	#define DISPLAY_MLC_RGB_FORMAT                            					MLC_RGBFMT_R5G6B5
	#define DISPLAY_MLC_BYTE_PER_PIXEL                        					2
#endif
...
//// PRIMARY DPC ////
#ifdef  CONFIG_FB_POLLUX_LCD43
	#define DISPLAY_PRI_MAX_X_RESOLUTION                  						480
	#define DISPLAY_PRI_MAX_Y_RESOLUTION                  						272
#else
	#ifndef  CONFIG_FB_POLLUX_LCD28240x320
	    #define DISPLAY_PRI_MAX_X_RESOLUTION                  						320
	    #define DISPLAY_PRI_MAX_Y_RESOLUTION                  						240
    #else
        #define DISPLAY_PRI_MAX_X_RESOLUTION                  						240
	    #define DISPLAY_PRI_MAX_Y_RESOLUTION                  						320
    #endif
#endif

#define DISPLAY_LCD_PRI_STN_TYPE            								CFALSE

#if ( DISPLAY_LCD_PRI_STN_TYPE == CTRUE )
#define DISPLAY_DPC_PRI_STN_VM_INVERT	                  					CFALSE
#define DISPLAY_DPC_PRI_STN_HSYNC_BUS_WIDTH                					0
#define DISPLAY_DPC_PRI_STN_HSYNC_ACTIVE_WIDTH             					0
#define DISPLAY_DPC_PRI_STN_HSYNC_CP1HWIDTH                					0
#define DISPLAY_DPC_PRI_STN_HSYNC_CP1CP2_DELAY             					0
#define DISPLAY_DPC_PRI_STN_HSYNC_CP2_CYCLE                					0
#define DISPLAY_DPC_PRI_STN_VSYNC_ACTIVE_LINE             					0
#define DISPLAY_DPC_PRI_STN_VSYNC_BLANK_LINE               					0
#else
	#ifdef CONFIG_FB_POLLUX_LCD43
	
	#define DISPLAY_DPC_PRI_TFT_HSYNC_SWIDTH                      				41
	#define DISPLAY_DPC_PRI_TFT_HSYNC_FRONT_PORCH                 				8
	#define DISPLAY_DPC_PRI_TFT_HSYNC_BACK_PORCH                  				45
	#define DISPLAY_DPC_PRI_TFT_HSYNC_ACTIVEHIGH                  				CFALSE
	#define DISPLAY_DPC_PRI_TFT_VSYNC_SWIDTH                      				10
	#define DISPLAY_DPC_PRI_TFT_VSYNC_FRONT_PORCH                 				4
	#define DISPLAY_DPC_PRI_TFT_VSYNC_BACK_PORCH                  				12
	...
	#define DISPLAY_DPC_PRI_TFT_HSYNC_SWIDTH                      				2
	#define DISPLAY_DPC_PRI_TFT_HSYNC_FRONT_PORCH                 				50
	#define DISPLAY_DPC_PRI_TFT_HSYNC_BACK_PORCH                  				36
	#define DISPLAY_DPC_PRI_TFT_HSYNC_ACTIVEHIGH                  				CFALSE
	#define DISPLAY_DPC_PRI_TFT_VSYNC_SWIDTH                      				1
	#define DISPLAY_DPC_PRI_TFT_VSYNC_FRONT_PORCH                 				4
	#define DISPLAY_DPC_PRI_TFT_VSYNC_BACK_PORCH                  				17
	#define DISPLAY_DPC_PRI_TFT_VSYNC_ACTIVEHIGH  	            				CFALSE
	#define DISPLAY_DPC_PRI_TFT_OUTORDER                       					DPC_ORDER_CbYCrY
	#define DISPLAY_DPC_PRI_TFT_SCAN_INTERLACE                       			CFALSE
	#define DISPLAY_DPC_PRI_TFT_POLFIELD_INVERT                    				CFALSE	
...
#ifdef CONFIG_FB_POLLUX_LCD43
	#define DISPLAY_DPC_PRI_VCLK_DIV                          					15
#else
	#define DISPLAY_DPC_PRI_VCLK_DIV                          					23
#endif
...
#else
	#define DISPLAY_DPC_PRI_OUTPUT_FORMAT                     				DPC_FORMAT_RGB666
#endif
...
#define DISPLAY_LCD_PRI_BIRGHTNESS_ACTIVE            						1
